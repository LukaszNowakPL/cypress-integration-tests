...
export default function() {
    createServer({
        ...
        seeds(server) {
            ...
            server.create('airport', {id: '1', country_id: '1', name: 'Warsaw', iata: 'WAW'});
            server.create('airport', {id: '4', country_id: '1', name: 'Cracov', iata: 'KRK'});
            ...
            server.create('airport', {id: '13', country_id: '3', name: 'Madrid', iata: 'MAD'});
